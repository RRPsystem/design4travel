...
export function makeHandler(deps: HandlerDeps) {
  return async function handle(req: Request): Promise<Response> {
    ...
    try {
      rpcResult = (await admin.rpc("create_project_with_first_document", {
        p_actor_user_id: actorUserId,
        p_org_id: input.organization_id,
        p_project_name: input.project_name,
        p_project_description: input.project_description ?? null,
        p_first_document_type: input.first_document_type,
        p_first_document_title: input.first_document_title,
