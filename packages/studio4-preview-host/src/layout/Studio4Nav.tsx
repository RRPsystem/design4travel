...
/**
 * Mock Studio4-nav voor de preview-host. Ondersteunt twee varianten:
 * - `transparent` — overlays de sectie (voor hero-secties met full-bleed bg)
 * - `opaque` — normale witte nav met border-bottom
 *
 * Design4-componenten mogen NIET zelf een <nav> renderen; die verwachten dat
 * dit door SiteLayout bovenop wordt geplaatst. Deze mock simuleert dat.
 */
